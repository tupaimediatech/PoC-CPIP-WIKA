...
class WorkbookFieldMapper
{
    ...
    private const BUILTIN_ALIASES = [
        'project' => [
            ...
            'total_pagu' => 'bq_external',
            'bq_external' => 'bq_external',
            'hpp_plan_total' => 'actual_costs',
            'actual_costs' => 'actual_costs',
            'hpp_actual_total' => 'realized_costs',
        ...
        'work_item' => [
            ...
            'material_id' => 'id_resource',
            'kode_material' => 'id_resource',
            'material_code' => 'id_resource',
            'kategori_resource' => 'resource_category',
            'resource_category' => 'resource_category',
            'kategori_material' => 'resource_category',
            'material_category' => 'resource_category',
            'kelompok_material' => 'resource_category',
            'kategori' => 'cost_category',
            'kateogri' => 'cost_category',
            'item_pekerjaan' => 'item_name',
            'b_item_pekerjaan' => 'item_name',
            'quantity' => 'quantity',
            'qty_resource' => 'quantity',
            'jumlah_resource' => 'quantity',
            'price' => 'price',
            'unit_price' => 'price',
            'harga_satuan_resource' => 'price',
            'harga_resource' => 'price',
            ...
            'unit' => 'satuan',
            'unit_resource' => 'unit',
            'satuan_resource' => 'unit',
            'quantity' => 'quantity',
            'qty' => 'quantity',
            'jumlah' => 'quantity',
            'price' => 'price',
            'harga_satuan_resource' => 'price',
            'harga_satuan_display' => 'price',
            // Budget fields
        ...
        'material' => [
            ...
            'item_pekerjaan' => 'material_type',
            'uraian_pekerjaan' => 'material_type',
            'qty' => 'qty',
            'jumlah' => 'qty',
            'volume_aktual' => 'qty',
            'vol_aktual' => 'qty',
            ...
            'nilai_kontrak_vendor' => 'total_tagihan',
            'kontrak_vendor' => 'total_tagihan',
            'harga_satuan' => 'harga_satuan',
            'harsat_aktual' => 'harga_satuan',
            'harga' => 'harga_satuan',
            'total_tagihan' => 'total_tagihan',
            'total' => 'total_tagihan',
            'tahun_perolehan' => 'tahun_perolehan',
            'tahun' => 'tahun_perolehan',
            'year_acquired' => 'tahun_perolehan',
            'lokasi_vendor' => 'lokasi_vendor',
            'lokasi' => 'lokasi_vendor',
            'kota_vendor' => 'lokasi_vendor',
            'rating_performa' => 'rating_performa',
            'rating' => 'rating_performa',
            'performa_vendor' => 'rating_performa',
            'realisasi_pengiriman' => 'realisasi_pengiriman',
            'pengiriman' => 'realisasi_pengiriman',
            'delivery_rate' => 'realisasi_pengiriman',
            'deviasi_harga_market' => 'deviasi_harga_market',
            'deviasi_harga_pasar' => 'deviasi_harga_market',
            'market_deviation' => 'deviasi_harga_market',
            'catatan_monitoring' => 'catatan_monitoring',
            'catatan' => 'catatan_monitoring',
            'monitoring_note' => 'catatan_monitoring',
        ],
        'equipment' => [
            'vendor' => 'vendor_name',
            'nama_vendor' => 'vendor_name',
    ...
    public function parseFieldValue(string $field, mixed $value): mixed
    {
        return match ($field) {
            ...
            'tahun_perolehan' => $this->parseInteger($value),
            'progress_pct',
            'progress_prev_pct',
            'progress_this_pct',
            'progress_total_pct',
    ...
    public function confidenceAdjustment(string $field, mixed $normalizedValue): int
    {
        ...
        return match ($field) {
            ...
            'contract_value', 'addendum_value', 'bq_external', 'actual_costs', 'realized_costs', 'planned_cost', 'actual_cost',
            'volume', 'harsat',
            'budget_awal', 'addendum', 'total_budget', 'realisasi', 'deviasi',
            'qty', 'quantity', 'price', 'harga_satuan', 'total_tagihan', 'jam_kerja', 'rate_per_jam', 'total_biaya'
