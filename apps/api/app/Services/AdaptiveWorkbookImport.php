    ...
    private function syncWorkItems(ProjectWbs $wbsPhase, array $rows): void
    {
        ...
        foreach ($rows as $row) {
            ...
            $item = ProjectWorkItem::create([
                ...
                'item_no' => $itemNo ?: null,
                'item_name' => $itemName,
                'id_resource' => $row['id_resource'] ?? null,
                'resource_category' => $row['resource_category'] ?? null,
                'unit' => $row['unit'] ?? $row['satuan'] ?? null,
                'quantity' => $row['quantity'] ?? $row['volume'] ?? null,
                'price' => $row['price'] ?? $row['harsat_internal'] ?? null,
