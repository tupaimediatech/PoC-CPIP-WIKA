...
const EMPTY_FILTERS: FilterState = { sbu: '', owner: '', partnership: '', division: '' };
...
export default function QuickFilterPreview({ onSearch, onReset }: QuickFilterPreviewProps) {
  ...
  const handleReset = () => { setFilters(EMPTY_FILTERS); onReset(); };
...
function FilterPill({ label, value, placeholder, options, onChange }: {
